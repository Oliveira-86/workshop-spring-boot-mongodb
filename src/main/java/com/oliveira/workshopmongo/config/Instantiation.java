package com.oliveira.workshopmongo.config;
...
import com.oliveira.workshopmongo.dto.AuthorDTO;
import com.oliveira.workshopmongo.dto.CommentDTO;
import com.oliveira.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/0/2018"), "Bom dia", "Acordei feliz hoje", new AuthorDTO(maria));
